...
typedef SWIFT_ENUM(uint8_t, Environment) {
...
@interface ZMSLog (SWIFT_EXTENSION(WireSystem))
/// Adds a log hook
+ (LogHookToken * _Nonnull)addHookWithLogHook:(void (^ _Nonnull)(ZMLogLevel_t, NSString * _Nullable, NSString * _Nonnull))logHook SWIFT_WARN_UNUSED_RESULT;
/// Adds a log hook without locking
+ (LogHookToken * _Nonnull)nonLockingAddHookWithLogHook:(void (^ _Nonnull)(ZMLogLevel_t, NSString * _Nullable, NSString * _Nonnull))logHook SWIFT_WARN_UNUSED_RESULT;
/// Remove a log hook
+ (void)removeLogHookWithToken:(LogHookToken * _Nonnull)token;
...
SWIFT_CLASS("_TtCC10WireSystem6ZMSLog12LogHookToken")
@interface LogHookToken : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
